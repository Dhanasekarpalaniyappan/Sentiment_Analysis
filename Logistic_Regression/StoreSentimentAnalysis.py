...
reviews_train_clean = removeWhiteSpace(reviews_train)
reviews_test_clean = removeWhiteSpace(reviews_test)
...
final_model = make_pipeline(StandardScaler(with_mean=False), LogisticRegression(C=0.05))
